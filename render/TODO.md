...
[ ] - Mechanics and Formulae
    ...
    [ ] - Basic Damage: Archery = (Sum of both hands' Attack + Strength - Enemy's Vitality / 2 - Enemy's Def / 2 + Sum of both hands' Melee Prof. / 2) x (Attack / Enemy's Def.) x Weapon Property Adjustment x Magical Property Adjustment
        [ ] - The (Attack / Enemy's def) term has a permitted maximum of 2.
        [ ] - Property Adjustment is 2 if it is weakness, 0.5 if it is resistance.

    [ ] - Basic Damage: Harps = Attack of Weapon + Mind - Enemy's Mind - Enemy's Mag. Def.
    ...
    [ ] = Hit Rate: Archery = {[80 + Weapon Hit Rate + Agility / 10 + JobLV / 10 - Enemy's Agility / 20] / 2}%
        [ ] - Maximum is 95%.

    [ ] = Hit Rate: Harps = (40 + Mind - Enemy's Mind)%
        [ ] - Maximum is 95%.

    [ ] - Damage Inflicted = Basic Damage from both hands x Random No. x No. of Successful Hits x Critical Adjustment x Dual-hand Adjustment
    ...
    [ ] - Melee Proficiency : Each arm has its own proficiency, and the initial level is 1, maximum is 99.
